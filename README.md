...
> In several cases the audio generated by Gemini looped on a set of words, even with moments of silence on the microphone, in addition, in several tests, the voice changes when the session
> rotates.
